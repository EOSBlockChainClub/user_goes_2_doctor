...
docker stop eosio_fuzzy_container || true && docker rm --force eosio_fuzzy_container || true
...
echo "=== setup/reset data for mongo_fuzzy_container ==="
docker stop mongo_fuzzy_container || true && docker rm --force mongo_fuzzy_container || true
